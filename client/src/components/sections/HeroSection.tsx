...
export default function HeroSection() {
  ...
  // The background stays fixed for one viewport height of scroll, with the
  // video scrubbing across that same range, before the sections below rise
  // up and cover it in normal document flow.
